...
var timer, callcounter=0, apiCallLT=0;
var autoupdatastatus = "Off", refRate=60;
var btncolor="#009688";
var fetchtime;

var reqdate;
var tempapiurl = "https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByDistrict?district_id="; //737&date=";
// SAMPLE URL : https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/findByDistrict?district_id=737&date=09-11-2021

var selectedStateId = 36;
var selectedDistictId = 737;
var apiurl;
var freec="",paidc;

const statelist = document.querySelector('#stateList');
const statesNdistricts = [{"state_id":1,"state_name":"Andaman and Nicobar Islands",
"districts":[{"district_id":3,"district_name":"Nicobar"},{"district_id":1,"district_name":"North and Middle Andaman"},{"district_id":2,"district_name":"South Andaman"}]},
{"state_id":2,"state_name":"Andhra Pradesh",
"districts":[{"district_id":9,"district_name":"Anantapur"},{"district_id":10,"district_name":"Chittoor"},{"district_id":11,"district_name":"East Godavari"},{"district_id":5,"district_name":"Guntur"},{"district_id":4,"district_name":"Krishna"},{"district_id":7,"district_name":"Kurnool"},{"district_id":12,"district_name":"Prakasam"},{"district_id":13,"district_name":"Sri Potti Sriramulu Nellore"},{"district_id":14,"district_name":"Srikakulam"},{"district_id":8,"district_name":"Visakhapatnam"},{"district_id":15,"district_name":"Vizianagaram"},{"district_id":16,"district_name":"West Godavari"},{"district_id":6,"district_name":"YSR District, Kadapa (Cuddapah)"}]},
...
"districts":[{"district_id":151,"district_name":"North Goa"},{"district_id":152,"district_name":"South Goa"}]},
...
"districts":[{"district_id":476,"district_name":"Karaikal"},{"district_id":477,"district_name":"Mahe"},{"district_id":475,"district_name":"Puducherry"},{"district_id":478,"district_name":"Yanam"}]},
...
"districts":[{"district_id":535,"district_name":"East Sikkim"},{"district_id":537,"district_name":"North Sikkim"},{"district_id":538,"district_name":"South Sikkim"},{"district_id":536,"district_name":"West Sikkim"}]},
...
"districts":[{"district_id":138,"district_name":"Daman"},{"district_id":139,"district_name":"Diu"}]}
];

const districtlist = document.querySelector('#districtList');
const dists = [{"district_id":710,"district_name":"Alipurduar District"},
...
var cashint = []; // cache object array for interested
var cashintstorage = []; // records history data with timestamp
var cashnotint = []; // cache object array for not interested
var objformat = {id:99999,age:22,vac:"vaccine",cap:44}; // cache object
var matchind,matchfound=false,revision = false; // memory compare variables

const rawdata={"sessions":[
	{"center_id":723441,"name":"Chalbalpur SSK Covaxin","address":"Chalbalpur Village","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Raniganj","pincode":713347,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"447c51a1-892a-4ceb-997c-e8130102570d","date":"02-06-2021","available_capacity_dose1":4,"available_capacity_dose2":1,"available_capacity":5,"fee":"0","min_age_limit":18,"vaccine":"COVAXIN","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":547694,"name":"Durgapur SDH","address":"Bidhanagar","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Durgapur MC","pincode":713206,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"090eed96-a851-430e-a477-06efeb691c23","date":"02-06-2021","available_capacity_dose1":6,"available_capacity_dose2":2,"available_capacity":8,"fee":"0","min_age_limit":45,"vaccine":"COVISHIELD","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":712206,"name":"Panagarh spcl cata 18-44 Covax","address":"Panagarh","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Kanksa","pincode":713301,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"aed348a2-32d7-4a9a-a600-0c54f33db3e7","date":"02-06-2021","available_capacity_dose1":3,"available_capacity_dose2":0,"available_capacity":3,"fee":"0","min_age_limit":18,"vaccine":"COVAXIN","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":724209,"name":"IQ City MCH-CM","address":"IQ City Road","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Durgapur MC","pincode":713206,"from":"15:00:00","to":"17:00:00","lat":87,"long":23,"fee_type":"Paid","session_id":"3a3e1ece-4a76-4c40-8546-8762dca1f932","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":45,"vaccine":"COVISHIELD","slots":["03:00PM-05:00PM"]},
	{"center_id":709581,"name":"Tirat PHC Spl cata 18-44","address":"Tirat","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Raniganj","pincode":713304,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"12753f85-ba37-4bd9-b5d5-ed2be7e71735","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":18,"vaccine":"COVISHIELD","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":725659,"name":"SDH Spcl Cata 18 To 44 Covaxin","address":"Bidhanagar","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Durgapur MC","pincode":713206,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"c9ecb074-e7a7-48de-a1ff-1df70544492a","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":18,"vaccine":"COVAXIN","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":595924,"name":"Raniganj Covaxin","address":"Raniganj","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Raniganj","pincode":713324,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"5fc0ee52-3e99-4269-af8b-1267cd772489","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":45,"vaccine":"COVAXIN","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":608842,"name":"Tirat PHC","address":"Tirat","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Raniganj","pincode":713347,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"4e57da89-216e-4087-9f8e-8afe168b50ef","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":45,"vaccine":"COVISHIELD","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":576137,"name":"IQ City MCH","address":"IQ City Road","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Durgapur MC","pincode":713206,"from":"09:30:00","to":"14:00:00","lat":87,"long":23,"fee_type":"Paid","session_id":"6e9b0a4d-5cf8-465f-a32d-620d390c0093","date":"02-06-2021","available_capacity_dose1":6,"available_capacity_dose2":3,"available_capacity":9,"fee":"850","min_age_limit":18,"vaccine":"COVISHIELD","slots":["09:30AM-10:30AM","10:30AM-11:30AM","11:30AM-12:30PM","12:30PM-02:00PM"]},
	{"center_id":595937,"name":"Durgapur SDH Covaxin","address":"Bidhanagar","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Durgapur MC","pincode":713206,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"2bb2ed23-40f9-43b3-b5ad-303ed77b4f63","date":"02-06-2021","available_capacity_dose1":4,"available_capacity_dose2":6,"available_capacity":10,"fee":"0","min_age_limit":45,"vaccine":"COVAXIN","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":724781,"name":"Tewaripara Spl cata 18-44Covax","address":"Tewari Para Egara","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Raniganj","pincode":713340,"from":"11:00:00","to":"16:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"6631b3fe-5478-4600-afe6-57d7eac12889","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":18,"vaccine":"COVAXIN","slots":["11:00AM-12:00PM","12:00PM-01:00PM","01:00PM-02:00PM","02:00PM-04:00PM"]},
	{"center_id":576137,"name":"IQ City MCH","address":"IQ City Road","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Durgapur MC","pincode":713206,"from":"14:30:00","to":"16:00:00","lat":87,"long":23,"fee_type":"Paid","session_id":"6fb8682d-8c0f-4fa3-840a-7bf9681fc5d8","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"850","min_age_limit":45,"vaccine":"COVISHIELD","slots":["02:30PM-04:00PM"]},
	{"center_id":547703,"name":"Raniganj BPHC","address":"Raniganj Bazar","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Raniganj","pincode":713347,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"4e58bf4f-c907-4200-9228-439ebe74f418","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":45,"vaccine":"COVISHIELD","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":705379,"name":"Raniganj BPHC Spcl Cata 18-44","address":"Raniganj Bazar","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Raniganj","pincode":713347,"from":"09:00:00","to":"18:00:00","lat":23,"long":87,"fee_type":"Free","session_id":"b1ce4f28-0772-4cc1-89f5-d7da779bdb36","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":18,"vaccine":"COVISHIELD","slots":["09:00AM-11:00AM","11:00AM-01:00PM","01:00PM-03:00PM","03:00PM-06:00PM"]},
	{"center_id":724209,"name":"IQ City MCH-CM","address":"IQ City Road","state_name":"West Bengal","district_name":"West Bardhaman","block_name":"Durgapur MC","pincode":713206,"from":"15:00:00","to":"18:00:00","lat":87,"long":23,"fee_type":"Paid","session_id":"9eb868a1-964b-4827-b7ed-f9df4fabee4e","date":"02-06-2021","available_capacity_dose1":0,"available_capacity_dose2":0,"available_capacity":0,"fee":"0","min_age_limit":18,"vaccine":"COVISHIELD","slots":["03:00PM-05:00PM","05:00PM-06:00PM"]}
]};

// DYNAMIC API-URL FUNCTION

function createurl(){
	apiurl = tempapiurl + selectedDistictId + "&date=" + reqdate;
	document.title = "Vaccine Slots " + reqdate + " || ABHISKAR";
};

// function reseturl(){ 
// 	apiurl = ""; 
// 	document.querySelector('#dsel').disabled = false;
// 	document.querySelector('#dres').disabled = true;
// }

// SAMPLE DATA STORAGE

function getdataTestPurpose(){jsdata = rawdata;}
...
function getdata(){
	fetch(apiurl).then((response)=>{
		...
		jsdata = data;
	}).catch((error)=>{console.log(error); alert("Network not available");});
...
//AUTO REFRESH
function startTmr(){
	autoupdatastatus = "On - Every " + refRate + " Seconds.";
	document.querySelector('#slider').style.animation = "loading 60s linear infinite";
	document.querySelector('#statusbar').style.display = "block";
	
	timer = setInterval( function (){
		getdata();
		setTimeout(function(){freelivesorting();},1000);
		callcounter++;
	},refRate*1000);
	document.querySelector('#find').disabled = true;
	document.querySelector('#refstatus').disabled = true;
	document.querySelector('#clrstatus').disabled = false;
}

function stopTmr(){
	autoupdatastatus = "Off";
	callcounter = 0;
	...
	document.querySelector('#refstatus').disabled = false;
	document.querySelector('#clrstatus').disabled = true;
}

// START - NEW CUSTOMIZED VERSION 3.5

var pincodefilter = [713301,713304,713305,713324,713325,713340];
var txtcolor = "cyan";

var vaccinefilter = "";
var dosefilter = "Both";
var agefilter = "";
var historyfilter = true;

var matchfoundfirst = false, alertforfirst = false;
var matchfoundsecond = false, alertforsecond = false;

const dateholder = document.getElementById('dateselector');

initial(); // SET ALL INITIAL DATA

function initial(){
	populateStateList();
	// POPULATE WEST BENGAL DISTRICS ON LOAD
	for(var dist in dists){
		districtlist.children[28-dist].value = dists[dist].district_id;
		districtlist.children[28-dist].innerText = dists[dist].district_name;
	}
	createvaliddates(); 								// INITIAL FETCH CALL INCLUDED HERE
	
	// SET DEFAULTS FOR FILTER BUTTONS
	document.getElementById('datehighlighter').style.left = document.querySelectorAll('.dateoption')[0].offsetLeft+"px";
	document.querySelector('#agehighlighter').style.left =  document.querySelectorAll('.agetype')[2].offsetLeft+ "px";
	document.querySelector('#dosehighlighter').style.left =  document.querySelectorAll('.dosetype')[2].offsetLeft+ "px";
	document.querySelector('#vaccinehighlighter').style.left =  document.querySelectorAll('.vaccinetype')[2].offsetLeft+ "px";
	//createurl();
	document.getElementById('slider').style.setProperty('--statusbar-width',document.getElementById('menu').clientWidth+50+"px");
	document.getElementById('datehighlighter').style.setProperty('--date-option-width',document.getElementsByClassName('dateoption')[0].clientWidth+"px");
	//console.log(document.getElementById('statusbar').clientWidth+50+"px");
	// updatelivedetails();
}

var row, infobtn;

function freelivesorting(){

	document.querySelector('#livefirstdiv').innerHTML = `<P style="text-align: center; color: green; font-weight: bold;">1st Dose ${vaccinefilter}</P>`;
	document.querySelector('#livesecondiv').innerHTML = `<P style="text-align: center; color: green; font-weight: bold;">2nd Dose ${vaccinefilter}</P>`;

	for(n in jsdata.sessions){
		if(jsdata.sessions[n].fee_type == "Free"){
			if(jsdata.sessions[n].available_capacity_dose1 > 0){
				for(p in pincodefilter){
					if(jsdata.sessions[n].pincode == pincodefilter[p]){
						txtcolor="cyan";
						matchfoundfirst = true;
						break;
					}
					else txtcolor = "white";
				}
				...
				infobtn.classList.add('vcinfo');
				infobtn.innerText ='i';
				infobtn.value = n;
				
				row.appendChild(infobtn);
				
				row.style = "color: " + txtcolor;
				row.innerHTML += "  " +
				jsdata.sessions[n].date.slice(0,5) + " - Age: " +						
				jsdata.sessions[n].min_age_limit + (jsdata.sessions[n].allow_all_age==true?" +  ":"") + " - " +
				jsdata.sessions[n].vaccine + " - D1: " +
				//jsdata.sessions[n].available_capacity + " - D1: " +
				jsdata.sessions[n].available_capacity_dose1 + " - " +
				//jsdata.sessions[n].available_capacity_dose2 + " - " +
				fetchtime.toLocaleTimeString() + " - " +
				jsdata.sessions[n].name;

				document.querySelector('#livefirstdiv').appendChild(row);
				//console.log(row);
			}
			if(jsdata.sessions[n].available_capacity_dose2 > 0){
				for(p in pincodefilter){
					if(jsdata.sessions[n].pincode == pincodefilter[p]){
						txtcolor="cyan";
						matchfoundsecond = true; //console.log(matchfoundsecond);
						break;
					}
					else txtcolor = "white";
				}
				...
				row.innerHTML += " "+
						jsdata.sessions[n].date.slice(0,5) + " - Age: " +						
						jsdata.sessions[n].min_age_limit + (jsdata.sessions[n].allow_all_age==true?" +  ":"") + " - " +
						jsdata.sessions[n].vaccine + " - D2: " +
						//jsdata.sessions[n].available_capacity + " - D2: " +
						//jsdata.sessions[n].available_capacity_dose1 + " - " +
						jsdata.sessions[n].available_capacity_dose2 + " - " +
						fetchtime.toLocaleTimeString() + " - " +
						jsdata.sessions[n].name;
				document.querySelector('#livesecondiv').appendChild(row);
				//console.log(row);
			}
		}
	}
	if(matchfoundfirst && alertforfirst){ // ALARM FOR FIRST DOSE
		playSuccess();
		matchfoundfirst = false;
	}
	if(matchfoundsecond && alertforsecond){ // ALARM FOR SECOND DOSE
		playError();
		matchfoundsecond = false;
	}
	if(vaccinefilter != ""){ screenbyvaccine(vaccinefilter); }

	document.querySelectorAll('.vcinfo').forEach(z => {z.addEventListener('click',showdetails);})
	centercalc();
	updatelivedetails();
}

function screenbydose(el){
	//VISUAL CUE
	dosefilter = el.innerText;
	document.querySelector('#dosehighlighter').style.left =  el.offsetLeft+ "px";

	if (el.innerText=="1st"){
		document.getElementById('livefirstdiv').style.display="block";
		document.getElementById('livesecondiv').style.display="none";
		alertforfirst = true; alertforsecond = false;
	}
	else if (el.innerText=="2nd"){
		document.getElementById('livesecondiv').style.display="block";
		document.getElementById('livefirstdiv').style.display="none";
		alertforfirst = false; alertforsecond = true;
		document.getElementById('livesecondiv').style.border="none";
	}
	else {
		document.getElementById('livefirstdiv').style.display="block";
		document.getElementById('livesecondiv').style.display="block";
		alertforfirst = false; alertforsecond = false;
		document.getElementById('livesecondiv').style.borderLeft="2px solid gray";
	}
}

function screenbyvaccine(vac,btv){
	vaccinefilter = vac;
	//VISUAL CUE
	document.querySelector('#vaccinehighlighter').style.left =  btv.offsetLeft+ "px";
	// document.querySelectorAll('.vaccinetype').forEach(btv => btv.style.backgroundColor = "white")
	// btv.style.backgroundColor = "cyan";
//TITLE MODIFIER
	document.querySelector('#livefirstdiv').firstChild.innerText = vaccinefilter + "  1st Dose";
	document.querySelector('#livesecondiv').firstChild.innerText = vaccinefilter + "  2nd Dose";
//STRAINER FOR 1ST DOSE
	document.querySelector('#livefirstdiv').childNodes.forEach(m=> {
		if(!m.innerText.includes(vaccinefilter)){ m.style.display="none";}
		else m.style.display="block";
	});
//STRAINER FOR 2ND DOSE
	document.querySelector('#livesecondiv').childNodes.forEach(m=> {
		if(!m.innerText.includes(vaccinefilter)){ m.style.display="none";}
		else m.style.display="block";
	});
}

function screenbyage(ag,bta){
	agefilter = ag;
//VISUAL CUE
	document.querySelector('#agehighlighter').style.left =  bta.offsetLeft+ "px";
//TITLE MODIFIER
	document.querySelector('#livefirstdiv').firstChild.innerText = vaccinefilter + "  1st Dose for " + bta.innerText;
	document.querySelector('#livesecondiv').firstChild.innerText = vaccinefilter + "  2nd Dose for " + bta.innerText;
//STRAINER FOR 1ST DOSE
	document.querySelector('#livefirstdiv').childNodes.forEach(m=> {
		if(m.innerText.includes("Age: "+agefilter) && m.innerText.includes(vaccinefilter)){ m.style.display="block";}
...
//STRAINER FOR 2ND DOSE
	...
	document.querySelector('#livefirstdiv').firstChild.style.display='block';
	document.querySelector('#livesecondiv').firstChild.style.display='block';
}

function populateStateList(){
	var stateoptions;

	statesNdistricts.forEach(st=>{
		stateoptions = document.createElement('option');

		stateoptions.value = st.state_id;
		stateoptions.innerText = st.state_name;
		//SET DEFAULT VALUE ON LOAD
		if(st.state_name == "West Bengal"){
			stateoptions.setAttribute('selected',true);
		}

		statelist.appendChild(stateoptions);
	});
}

function setstate(){
	var districtoption, tempdistrictholder;
	selectedStateId = statelist.options[statelist.selectedIndex].value-1;
	tempdistrictholder = statesNdistricts[selectedStateId].districts;
	districtlist.innerHTML = "";

	for(var dist in tempdistrictholder){
		districtoption = document.createElement('option');

		districtoption.value = tempdistrictholder[dist].district_id;
		districtoption.innerText = tempdistrictholder[dist].district_name;

		if(tempdistrictholder[dist].district_name == "West Bardhaman"){
			districtoption.setAttribute('selected',true);
		}
		districtlist.appendChild(districtoption);
	}
}

function setdistrict(){
	selectedDistictId = districtlist.options[districtlist.selectedIndex].value;
	createurl();
}

// date selection function
function createvaliddates(){
	var dates; // BUTTON ELEMENT HOLDER

	var today = new Date(); //var currentDate = new Date(new Date().getTime() + 24 * 60 * 60 * 1000);
	var dayms = today.getTime();
	var dayloop;

	reqdate = today.getDate() + "-" + (today.getMonth()+1) +"-"+ today.getFullYear();
	document.title = "Dyn Ver 3.5 " + reqdate +"by A. Karmakar";

	createurl();
	getdata();

	for(var z=0;z<7;z++){
		dayloop = new Date(dayms);
		dates = document.createElement('button');
		dates.innerText = dayloop.toDateString().slice(0,10); // <<<<<<<<<<<<<<<<<<<<<<<<< add week day and month here
		dates.classList.add('dateoption');
		dates.setAttribute("data-datevalue",dayloop.getDate() + "-" + (dayloop.getMonth()+1) +"-"+ dayloop.getFullYear())
		
		dates.addEventListener('click',(el)=>datechanged(el.target));
		
		dateholder.appendChild(dates);

		dayms+= 24 * 60 * 60 * 1000;
	}

	setTimeout(()=>freelivesorting(),1000);
}
...
function datechanged(btn){
	reqdate = btn.getAttribute('data-datevalue');
	document.getElementById('datehighlighter').style.left = btn.offsetLeft+"px";;
...
var pincodes, nofcenters;
function updatelivedetails(){
	pincodes = "";
	nofcenters = (freec==""?"":"No of Centers : " + jsdata.sessions.length + " | Free : "+ freec + " | Paid : " + paidc);
	pincodefilter.forEach(p => { pincodes += p + " "});
	document.getElementById('livedetails').innerHTML = `Showing slots for <b>${districtlist[districtlist.selectedIndex].innerText}</b> district in ${statelist[statelist.selectedIndex].innerText} on <b>${reqdate}</b>. [${nofcenters}] ||  Vaccine Type : <b>${(vaccinefilter==""?"All":vaccinefilter)} - ${dosefilter}</b> dose for Age group <b>${(agefilter==""?"All":agefilter+"+")}</b>. 
	<br>
	Auto update : ${autoupdatastatus} ${(callcounter>0?"["+callcounter+"]":"")} | Alarm : ${!alertforfirst && !alertforsecond?"Off":(alertforfirst?"On for 1st dose":"On for 2nd dose")} | Pincode highlighted : ${(pincodes?pincodes:"None")} <button id="editpincode" onclick="editpin()">| Change Pincodes |</button>`;
}

document.onclick = updatelivedetails;

function editpin(){
	document.getElementById('pininput').value = pincodes;
	document.getElementById('pineditor').style.display = "block";
}

function changepin(){
	pincodefilter = document.getElementById('pininput').value.split(" ");
	document.getElementById('pineditor').style.display = "none";
}

function centercalc(){
	freec = 0; // var tmp=" ( ";
	for(var c in jsdata.sessions){	if(jsdata.sessions[c].fee_type== "Free"){ freec+=1; } // else{ tmp = tmp + c + " "; }
	}
	paidc = (jsdata.sessions.length - freec);// + tmp + ")";
}

function showdetails(){
centerDetails = "Details of the Center : \r";
for(var dtls in jsdata.sessions[this.value]){ centerDetails += dtls.toUpperCase() + " :    " + jsdata.sessions[this.value][dtls] + " ;\r"; }
...
// END - NEW CUSTOMIZED VERSION 3.5
						
// REDUNDANT FUNCTION TO DOUBLE CHECK DOSE 1 AVAILIBILTY
function redundancy(){
	for(var r in jsdata.sessions){
		if (jsdata.sessions[r].available_capacity_dose1 > 0 && jsdata.sessions[r].fee_type == "Free"){
			console.log(jsdata.sessions[r]);
		}
	}
}
